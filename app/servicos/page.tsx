        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6">
            {services.map((s) => (
              ...
              >
                <div className="bg-gradient-to-br from-brand-primary to-brand-primary-dark p-6 text-white">
                ...
                <div className="p-6">
                  <p className="text-brand-mid mb-4">{s.desc}</p>
                  <div className="flex flex-wrap gap-2 mb-5">
                    {s.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs px-3 py-1 rounded-full border border-brand-primary/20 bg-brand-primary-light text-brand-primary font-medium"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section className="py-14 bg-white">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item} className="flex items-center gap-2 text-brand-mid">
          ...
          <div className="bg-brand-primary-light rounded-2xl p-8 text-center">
            ...
            <p className="text-brand-mid mb-6">Avaliação média no Google</p>
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="bg-white rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-primary font-heading">15+</div>
                <div className="text-brand-mid text-sm">Anos no mercado</div>
              </div>
              <div className="bg-white rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-primary font-heading">5.000+</div>
                <div className="text-brand-mid text-sm">Pacientes</div>
              </div>
              <div className="bg-white rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-primary font-heading">8</div>
                <div className="text-brand-mid text-sm">Especialidades</div>
              </div>
              <div className="bg-white rounded-xl p-4">
                <div className="text-2xl font-bold text-brand-primary font-heading">15+</div>
                <div className="text-brand-mid text-sm">Especialistas</div>
              </div>
            </div>
            <CtaButton className="mt-6 inline-flex items-center gap-2 bg-brand-wa hover:bg-brand-wa-dark text-white font-bold px-6 py-3 rounded-xl transition-all hover:scale-105">
              Agendar agora
            </CtaButton>
          </div>
        </div>
      ...
      <section className="py-14 bg-brand-ink text-white text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <CtaButton className="inline-flex items-center justify-center gap-2 bg-brand-wa hover:bg-brand-wa-dark text-white font-bold text-lg px-8 py-4 rounded-xl transition-all hover:scale-105">
              Falar pelo WhatsApp
            </CtaButton>
            <CtaButton className="inline-flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-white/10 font-semibold text-lg px-8 py-4 rounded-xl transition-all">
              Tirar dúvidas
            </CtaButton>
          </div>
        </div>
