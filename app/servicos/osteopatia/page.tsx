...
import { CheckCircle, Star, Phone, Heart, Activity, Shield, Smile, ArrowRight, MapPin } from "lucide-react";
      ...
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[{ v:"15+", l:"Anos de Clínica" },{ v:"5.000+", l:"Pacientes" },{ v:"Global", l:"Abordagem" },{ v:"4.9⭐", l:"Google" }].map((s) => (
